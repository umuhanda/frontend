...
const RevisionStudy = () => {
  ...
  const course = revisionQuestions.find((course) => course.id === parseInt(id || ""));
  const notes = course?.questions || [];
      ...
      <div className="p-6 space-y-6 relative">
        ...
        {notes.length > 0 ? (
          <div className="flex flex-col items-center space-y-4">
            ...
            /> */}
            <p className="text-gray-700 text-lg py-6 max-h-64 max-w-full">
              {notes[currentNoteIndex].question}
            </p>
          </div>
        ) : (
